...
<p align="center">
PREMIUM VERSION 1:
<a href="https://jamnuker.sellpass.io//">BUY (5$)</a>
</p>
<p align="center">
PREMIUM VERSION 2 (With token generator):
<a href="https://jamnuker.sellpass.io//">BUY (10$)</a>
</p>
...
> **WARNING:** Many people have been selling/distributing of Jam-Nuker!

> **DO NOT** Installing Jam-Nuker From Anyother Place Than This Page, Expect it be **Hacked/Scammed.**

## Installation

#### Source Code Version (More complicated but less buggy)
```sh-session
Download Jam-Nuker.zip
Extract File
Tap "Install.bat" in Jam Nuker Folder
Once All The Modules Have Been Installed Jam Nuker will Auto Launch!
Enjoy!

NOTE: When Opening Jam-Nuker Just Tap "start.bat" to Open Everytime!
NOTE: Make sure you have Python 3.9+ and Added to Path.
```

#### Compiled Version (Easier but more buggy)
```sh-session
Download: https://github.com/JamSheets/jam-nuker/releases
Extract File
Download the latest release (Jam-Nuker.zip) and Extract The Executable
